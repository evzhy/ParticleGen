...
Аббревиатуры:
 ...
 пассивный буфер - хранится в каждом потоке обработки, имеет фиксированный размер (максимум_частиц / число_потоков). Используется для чтения рендерером основного потока и расчётом частиц с нулевого элемента по число_используемых_частиц-1, используется на запись синхронизатором потоков с числа_используемых_частиц до конца для записи частиц новых эффектов.
